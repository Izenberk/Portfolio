			...
			>
				...
				>
					<motion.g variants={groupScale} initial="normal" animate={controls}>
						<motion.path d="m16 18 6-6-6-6" variants={drawRight} initial="normal" animate={controls} />
						<motion.path d="m8 6-6 6 6 6" variants={drawLeft} initial="normal" animate={controls} />
					</motion.g>
				</motion.svg>
			</motion.div>
		);
