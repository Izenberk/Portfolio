	...
	({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
		...
		const svgVariants: Variants = {
			...
			animate: {
				y: [0, -3, 3, -2, 0],
				scale: [1, 1.05, 0.95, 1],
				transition: { duration: 1.6, ease: [0.42, 0, 0.58, 1], repeat: 0 },
			},
		};
		...
		return (
			...
			>
				...
				>
					<motion.path d="M17 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 1-1.732" variants={outlineVariants} />
					<motion.path d="m22 5.5-6.419 4.179a2 2 0 0 1-2.162 0L7 5.5" variants={flapVariants} />
					<motion.rect x="7" y="3" width="15" height="12" rx="2" variants={outlineVariants} />
				</motion.svg>
			</motion.div>
		);
	},
